...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full border-t border-[var(--borderColor)] bg-[var(--bgColor)]">
      <div className="constrained-width mx-auto px-5 py-12 sm:px-8">
        <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
          <div className="flex max-w-sm flex-col gap-3">
            <Link
              href="#hero"
              className="w-fit font-display text-lg font-semibold text-[var(--textColor)]"
            >
              Vinay Jain
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-[var(--borderColor)] pt-6 sm:flex-row sm:items-center sm:justify-between">
